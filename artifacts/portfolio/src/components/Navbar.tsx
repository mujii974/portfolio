...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-4 z-50 transition-all duration-300 flex items-center justify-center gap-2 left-4 right-4 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 ${
          scrolled ? "sm:max-w-2xl" : "sm:max-w-3xl"
        }`}
      >
